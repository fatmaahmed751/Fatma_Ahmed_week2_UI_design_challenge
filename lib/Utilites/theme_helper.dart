...
class ThemeClass extends ThemeModel{
  ...
  ThemeClass.lightTheme({
    ...
    super.primaryColor = const Color(0xff2C1E51),
    //botton
    super.mainSecondary = const Color(0xff5436F8),
    //watch
    super.secondary = const Color(0xff6758FE),
    super.labelColor = const Color(0xffDCDCDC),
    super.mainBlack = const Color(0xff000000),
    super.secondaryBlackColor = const Color(0xffA9A9A9),
    super.waiting = const Color(0xffd9d9d9),
    super.cancel = const Color(0xffEA3829),
    super.success = const Color(0xff18153F),
